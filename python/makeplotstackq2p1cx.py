...
pre="../data/"
str3=pre+"plot_cxq2p1_%(res)s_%(jump)s_%(scale)s.txt" % {"res": res, "jump": "10e3", "scale": scale}
str6=pre+"plot_cxq2p1_%(res)s_%(jump)s_%(scale)s.txt" % {"res": res, "jump": "10e6", "scale": scale}
str9=pre+"plot_cxq2p1_%(res)s_%(jump)s_%(scale)s.txt" % {"res": res, "jump": "10e9", "scale": scale}
...
str=d+"stacksolcxq2p1ConditionNumbers%(res)s%(scale)s" % {"res": res, "scale": scale}
print str
plt.savefig(str)
