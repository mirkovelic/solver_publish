...
print "Usage:"
print "./makeplotstackq1p0cx.py <res> <no_scale|scaled>\n"
...
pre="../data/"
str3=pre+"plot_cx_%(res)s_%(jump)s_%(scale)s.txt" % {"res": res, "jump": "10e3", "scale": scale}
str6=pre+"plot_cx_%(res)s_%(jump)s_%(scale)s.txt" % {"res": res, "jump": "10e6", "scale": scale}
str9=pre+"plot_cx_%(res)s_%(jump)s_%(scale)s.txt" % {"res": res, "jump": "10e9", "scale": scale}
...
str=d+"stacksolcxq1p0ConditionNumbers%(res)s%(scale)s" % {"res": res, "scale": scale}
plt.savefig(str)
print str
#print x
#print y
